...
void loadLevel2Assets()
{
	...
	playerBg[4] = iLoadImage("Image//bg3.png");
	playerBg[5] = iLoadImage("Image//bg5.png");
	...
	botBg[4] = iLoadImage("Image//b3.png");
	botBg[5] = iLoadImage("Image//b5.png");
	...
	levelBorder = iLoadImage("Image//border.png");
